...
function DashObjetsList() {
  ...
  const fetchObjets = async () => {
    try {
      const response = await axios.get("/api/admin/objets");
      const objetsData = response.data?.objets; // Extraire le tableau d'objets de la réponse
